...
Sistema de Inimigos Melhorado:
Classe Inimigo para gerenciar múltiplos inimigos
Aparecem mais rápido e em maior quantidade (5 inimigos)
Movimento mais suave com velocidade ajustável


Sistema de Tiros Corrigido:
Classe Tiro para melhor controle
Tiro agora é visível e bem posicionado
Sistema de cooldown para evitar disparos rápidos demais


Performance e Organização:
Controle de FPS (60 frames por segundo)
Código mais organizado com classes
...
Balanceamento:
Velocidades ajustadas para melhor jogabilidade
Sistema de pontuação mais justo



Como Funciona Agora:
Inimigos: Aparecem continuamente na parte superior e descem

Tiros: Disparam ao pressionar espaço, com pequeno delay entre disparos

Colisões: Detectadas precisamente entre tiros, jogador e inimigos

Pontuação: Aumenta ao acertar inimigos, diminui ao colidir com eles"""